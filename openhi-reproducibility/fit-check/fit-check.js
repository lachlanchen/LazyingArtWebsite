(() => {
  ...
  const subject = "OpenHI Software Reproducibility — free fit check";
  ...
  const buildPayload = () => {
    ...
    return {
      ...
      target_stage: clean(data.get("target_stage")),
      dependencies: clean(data.get("dependencies")),
  ...
  const buildRequest = (payload) => {
    ...
    return [
      ...
      "",
      "Role and authority to share the data:", payload.role,
      "",
      "Existing workstation and software environment:", payload.environment,
      "",
      "Dataset shape and rights:", payload.source,
      "",
      "Target pipeline stage and decision:", payload.target_stage,
      "",
      "Vendor or licensed dependencies:", optional("dependencies"),
      "",
      "Confidentiality, retention, and other constraints:", optional("constraints"),
      "",
      "Rights confirmation: I am authorized to request the work and provide the agreed dataset.",
      "Scope confirmation: I understand the fixed USD 500 sprint covers one existing workstation, one rights-cleared dataset, and one named OpenHI software stage. Hardware, acquisition, optical calibration, licensed SDK procurement, custom algorithms, production integration, and scientific or publication guarantees are excluded.",
