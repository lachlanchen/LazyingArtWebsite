...
const cases = [
  ...
  {
    encryptedIntakeAvailable: true,
    name: "mcp_boundary_review",
    email: "contact@lazying.art",
    path: "../mcp-boundary-review/fit-check/fit-check.js",
    ...
    expectedKeys: [
      "client_elapsed_ms", "client_transport", "constraints", "contact_email",
      "environment", "offer", "repository", "rights_confirmed", "risk", "role",
      "scope_confirmed", "surface", "utm_campaign", "utm_source", "website",
    ],
  },
  {
    encryptedIntakeAvailable: true,
    ...
    email: "contact@lazying.art",
    path: "../browser-regression/fit-check/fit-check.js",
    pageUrl: "https://lazying.art/browser-regression/fit-check/",
    values: {
      contact_email: "owner@example.com",
      site_url: "https://example.com; product owner authorized to request testing.",
      flows: "1. Open the guide and change language. 2. Use the mobile menu. 3. Reset the map.",
    ...
    expectedKeys: [
      "client_elapsed_ms", "constraints", "contact_email", "delivery",
      "environment", "flows", "instability", "offer", "rights_confirmed",
      "scope_confirmed", "site_url", "utm_campaign", "utm_source", "website",
    ],
  },
  {
    encryptedIntakeAvailable: true,
