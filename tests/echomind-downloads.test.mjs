...
const file = "downloads/EchoMind-0.1.0-build81-test.apk";
...
assert.equal(crypto.createHash("sha256").update(fs.readFileSync(new URL(file, root))).digest("hex"),
  "1de136e297a142541beab241fa91be28159af143cbb61216c9333334f556328f");
assert.ok(fs.existsSync(new URL("downloads/EchoMind-0.1.0-build80-test.apk", root)), "prior link remains recoverable");
