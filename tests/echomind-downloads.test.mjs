...
const file = "downloads/EchoMind-0.1.0-build76-test.apk";
...
assert.equal(crypto.createHash("sha256").update(fs.readFileSync(new URL(file, root))).digest("hex"),
  "9cd780e37112a4b54d926183143249307b62e1c4daa632e1edaf8b67a8349c09");
assert.ok(fs.existsSync(new URL("downloads/EchoMind-0.1.0-build75-test.apk", root)), "prior link remains recoverable");
