...
assert.match(fitCheck, /Nothing is sent until you review the request and choose “Send fit check.”/);
...
assert.match(offer, /send the encrypted request here, open it in your email app, or copy it/);
assert.match(sampleReport, /sending the encrypted request here, opening it in your email app, or copying it/);
