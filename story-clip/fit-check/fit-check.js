(() => {
  ...
  const subject = "Story Clip Pilot — free fit check";
  ...
  const buildPayload = () => {
    ...
    return {
      ...
      audience_platform: clean(data.get("audience_platform")),
  ...
  const buildRequest = (payload) => {
    ...
    return [
      ...
      "",
      "Source duration, format, and condition:",
      payload.source,
      "",
      "Source language and supplied names:",
      payload.language,
      "",
      "Rights controlled for the requested edit:",
      payload.rights_scope,
      "",
      "Audience and platform:",
      payload.audience_platform,
      "",
      "What the clip should communicate:",
      payload.goal,
      "",
      "Other constraints:",
      optional("constraints"),
      "",
      "Rights confirmation: I control the requested use or can identify the license and permissions that allow it.",
      "Scope confirmation: I understand the fixed USD 250 pilot begins only after the free fit check and has the stated boundaries.",
