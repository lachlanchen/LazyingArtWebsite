...
如果你使用 LazyingArt 网站或其源码，请引用本仓库。GitHub 会读取 [CITATION.cff](../CITATION.cff)，并在仓库页面显示 **Cite this repository** 面板。
...
你也可以通过 [GitHub Sponsors](https://github.com/sponsors/lachlanchen) 支持持续开发。
