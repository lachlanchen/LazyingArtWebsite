(() => {
  const release = "https://github.com/lachlanchen/Kindle/releases/download/jailbreak-assistant-v0.1.1/";
  const assets = {
  ...
  const copy = {
    en: {
      ...
      release: "Version 0.1.1 / unsigned community build",
      windows: "Windows x64",
      linuxX64: "Linux x64",
    ...
    ja: {
      ...
      release: "バージョン 0.1.1 / 未署名コミュニティビルド",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    ko: {
      ...
      download: "컴퓨터용 다운로드",
      release: "버전 0.1.1 / 서명되지 않은 커뮤니티 빌드",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    de: {
      ...
      release: "Version 0.1.1 / unsignierter Community-Build",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    fr: {
      ...
      release: "Version 0.1.1 / build communautaire non signe",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    es: {
      ...
      release: "Version 0.1.1 / compilacion comunitaria sin firmar",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    it: {
      ...
      release: "Versione 0.1.1 / build community non firmata",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    pt: {
      ...
      release: "Versao 0.1.1 / build comunitaria nao assinada",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
    ...
    ru: {
      ...
      release: "Versiia 0.1.1 / nepodpisannaia sborka",
      windows: "Windows x64",
      linuxX64: "Linux x64",
      linuxArm: "Linux ARM64",
      macIntel: "macOS Intel",
